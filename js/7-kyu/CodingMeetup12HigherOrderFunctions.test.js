...
function findAdmin(list, lang) {
  ...
  return list.filter((coder) => coder.githubAdmin === 'yes' && coder.language === lang);
}
  ...
  it('test', () => {
    ...
    (function () {
      for (let i = 0; i < 20; i++) {
        ...
        const testedLang = languageList[getRandomNumber(0, languageList.length - 1)];
        ...
        const expected = findAdminSolution(listFullCopy, testedLang);
        const actual = findAdmin(listFullCopy, testedLang);
